                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      't845ozms' /* Let's get started by filling o... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          ...
                                                          text: FFLocalizations
                                                                  .of(context)
                                                              .getText(
                                                            'tqtvcilq' /* Continue with fackbook */,
                                                          ),
                                                          icon: const Icon(
                                                            Icons
                                                                .facebook_rounded,
